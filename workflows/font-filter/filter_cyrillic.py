...
# ---------------------------
# 1. Получение списка кириллических шрифтов
# ---------------------------
def get_cyrillic_fonts():
    # Пытаемся использовать API-ключ из переменных окружения
    ...
    # Fallback-список популярных кириллических шрифтов
